...
const logo = require('./libs//assets/logo.png');
...
export default class App extends React.Component {
    ...
    favoriPress = () => {
        this.setState({ favoriStatus: !this.state.favoriStatus },
            () => this.props.favori(this.state.favoriStatus))
    }
                ...
                <View style={{ flex: 1 }}>
                    {this.state.controls ? <>
                        <View style={styles.headerViewTop}>
                            ...
                            {
                                this.props.favoriStatus ? <TouchableOpacity
                                    onPress={() => this.props.favori(this.state.favoriStatus)}>
                                    <Image source={this.state.favoriStatus ? iconFavoriEnable : iconFavoriDisable}
                                        style={[styles.headerImage, { tintColor: "#000" }]} />
